  ...
  return (
    <div className="font-display">
      ...
      <section className="py-24 text-center px-6 md:px-12 lg:px-20">
        ...
        <Link to="/shop" className="bg-primary hover:bg-primary/90 text-white px-10 py-4 rounded-full font-bold transition-all shadow-lg transform hover:scale-105 inline-block">
            Shop the Collection
        </Link>
      </section>
    </div>
